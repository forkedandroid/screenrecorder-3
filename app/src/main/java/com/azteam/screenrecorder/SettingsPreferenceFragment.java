...
import com.azteam.screenrecorder.folderpicker.FolderChooser;
import com.azteam.screenrecorder.folderpicker.OnDirectorySelectedListerner;
...
public class SettingsPreferenceFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener
        ...
        new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        try {
                            getActivity().startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.azteam.screencamplugin")));
                        } catch (android.content.ActivityNotFoundException e) { // if there is no Google Play on device
                            getActivity().startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.azteam.screencamplugin")));
                        }
                    }
                })
    ...
    private boolean hasPluginInstalled(){
        ...
        try {
            pm.getPackageInfo("com.azteam.screencamplugin",PackageManager.GET_META_DATA);
